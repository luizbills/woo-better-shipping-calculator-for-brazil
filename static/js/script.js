...
window.jQuery(function ($) {
	var selectors = {
		select_country: '.woocommerce-shipping-calculator #calc_shipping_country',
		select_state: '.woocommerce-shipping-calculator #calc_shipping_state',
		input_postcode: '.woocommerce-shipping-calculator #calc_shipping_postcode'
	};

	var $state_select = $(selectors.select_state);
	var states_range = get_brazilian_states_range();

	$(document).on('keyup', selectors.input_postcode, function (evt) {
	...
	$( document.body ).on( 'updated_wc_div', function () {
		$state_select = $(selectors.select_state);
	} );
